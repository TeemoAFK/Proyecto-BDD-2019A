...
ckey = "uMu0VQj0udAu0Peoy2CKWw4Nd"
csecret = "dLMtB314UUJnLw3WLvRe1pFuDrLfiVNAss106jyX8CM7VtGuYA"
atoken = "926742758-MrAHAOGw62N9SvXyWVQ4YNl05X4ZBXlprFpfEwb1"
asecret = "JLH5fToKjEQBGGaFaq1m182CBwmMeo9Qhmx2FF5UlQN2V"
...
try:
    ...
    db = server.create('script')
except:
    #Caso contrario solo conectarse a la base existente
    db = server['script']
    
#Aqui se define el bounding box con los limites geograficos donde recolectar los tweets
twitterStream.filter(track=["#allyouneedisecuador","turismo","ecuador"])
